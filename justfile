...
broadcast nodes="1": (build "broadcast")
    maelstrom test -w broadcast --bin ./target/debug/broadcast --node-count {{nodes}} --time-limit 20 --rate 10 {{nemesis_arg}} --log-stderr --log-net-send --log-net-recv
...
counter: (build "counter")
    maelstrom test -w g-counter --bin ./target/debug/counter --node-count 1 --rate 10 --time-limit 20 --log-stderr --log-net-send --log-net-recv